...
import br.com.excel.util.REGEX;
import br.com.excel.util.RegexUtil;
...
public final class DefaultCBIHeaderRenderer extends DefaultTableCellRenderer {
    ...
    private final ImageIcon imageIcon1 = new ImageIcon(getClass().getResource("/br/com/sres/img/down.gif"));
    private final ImageIcon imageIcon2 = new ImageIcon(getClass().getResource("/br/com/sres/img/down_red.gif"));
    private final ImageIcon imageIcon3 = new ImageIcon(getClass().getResource("/br/com/sres/img/iconeCF.gif"));
    ...
    public void construiMenus(Class columnClass) {
        ...
        m1.setIcon(new ImageIcon(getClass().getResource("/br/com/sres/img/iconeAZ.gif")));
        m1.addActionListener(listener);
        JMenuItem m2 = new JMenuItem("Ordenar de Z a A...");
        m2.setActionCommand("ZA");
        m2.setIcon(new ImageIcon(getClass().getResource("/br/com/sres/img/iconeZA.gif")));
